const I18n = {
  ...
  translations: {
    es: {
      ...
      // Hero
      'hero.title_1': 'Seguimiento de tu portafolio',
      'hero.title_2': 'argentino en ',
      'hero.title_em': 'USD real',
      'hero.subtitle': 'Importa tus tenencias desde Balanz o Interactive Brokers. Ve tus retornos reales despues de la conversion MEP, el arrastre cambiario y toda la complejidad del mercado argentino.',
      'hero.btn_dashboard': 'Abrir Dashboard',
      'hero.btn_how': 'Como funciona',

      // Features
      'features.title': 'Hecho para inversores argentinos',
      'features.lead': 'No es otro tracker generico. ARGPT entiende CEDEARs, tipos de cambio MEP y el verdadero costo de tener activos argentinos.',
      'features.portfolio.title': 'Vista del portafolio',
      'features.portfolio.desc': 'Ve todas tus tenencias en una sola vista. Costo en ARS, valor de mercado en USD, distribucion de peso y P&L que tiene en cuenta el arrastre cambiario.',
      'features.technicals.title': 'Senales tecnicas',
      'features.technicals.desc': 'RSI, Estocastico, Supertrend y medias moviles para cada tenencia. Puntajes de salud con colores que muestran de un vistazo que posiciones son fuertes.',
      'features.fundamentals.title': 'Analisis fundamental',
      'features.fundamentals.desc': 'P/E, ROE, margenes y ratios de deuda comparados contra medianas del sector. Sabe si tu accion esta barata o cara respecto a sus pares.',

      // Currency section
      'currency.title_1': 'El problema del MEP,',
      'currency.title_2': 'resuelto',
      'currency.desc1': 'Todo inversor argentino conoce el dolor: tu CEDEAR subio 20% en pesos, pero el tipo de cambio MEP tambien se movio. Realmente ganaste plata en dolares?',
      ...
      'currency.desc2_2': ', mostrando el resultado real en USD. Importa tu MEP de entrada o fecha de compra y lo buscamos por vos.',
      'currency.header': 'Descomposicion del retorno',
      ...
      'workflow.step1.title': 'Importa tenencias',
      'workflow.step1.desc': 'Subi un export XLSX de Balanz o CSV de Interactive Brokers. O agrega posiciones manualmente con ticker, cantidad y precio de costo.',
      'workflow.step2.title': 'Precios en vivo',
      'workflow.step2.desc': 'ARGPT obtiene precios en tiempo real, tipos MEP/CCL, indicadores tecnicos y fundamentales de Data912 y finance-query.com.',
      'workflow.step3.title': 'Ve retornos reales',
      'workflow.step3.desc': 'Mira tu portafolio en USD. Entende la descomposicion precio vs. moneda. Detecta posiciones debiles y fuertes al instante.',

      // Asset types
      'assets.title': 'Tipos de activos cubiertos',
      'assets.cedear.title': 'Certificados de Deposito Argentinos',
      'assets.cedear.desc': 'Wrappers locales de acciones americanas, cotizados en ARS en BYMA. ARGPT convierte via MEP y maneja la matematica del ratio para que veas el valor real en USD.',
      'assets.arg.title': 'Acciones argentinas',
      'assets.arg.desc': 'Acciones listadas en BYMA como GGAL, YPF, TXAR. Cotizadas en ARS, convertidas a USD via tipo MEP para un seguimiento real en dolares.',
      ...
      'tab.technicals': 'Tecnicos',
      'tab.fundamentals': 'Fundamentales',
      'tab.glossary': 'Glosario',

      // Dashboard - warning
      'warning.fx': '\u26A0 Algunas tenencias no tienen tipo de cambio de entrada \u2014 los retornos en USD son aproximados. Edita las tenencias para agregar tu tipo MEP de compra para resultados precisos.',
      ...
      'form.hint_default': 'Ingresa fecha o tipo. La fecha autocompleta el tipo desde los datos.',
      'form.hint_using_mep': 'Usando MEP actual (${rate}). Edita si tu tipo de compra era diferente.',
      'form.add_btn': 'Agregar',

      // Dashboard - empty state
      'empty.text': 'Sin tenencias aun. Agrega una arriba para comenzar.',
      ...
      'th.ticker': 'Ticker',
      'th.ticker_tip': 'Simbolo del activo y tipo (CEDEAR, accion argentina, accion US)',
      'th.broker': 'Broker',
      'th.broker_tip': 'Broker donde se mantiene la posicion',
      'th.shares': 'Cantidad',
      'th.shares_tip': 'Numero de acciones/certificados',
      'th.avg_ars': 'Prom ARS',
      'th.avg_ars_tip': 'Precio promedio de compra en ARS por accion',
      'th.avg_usd': 'Prom USD',
      'th.avg_usd_tip': 'Precio promedio de compra en USD por accion (precio ARS \u00F7 tipo MEP de compra para activos argentinos)',
      ...
      'th.currency_pct_tip': 'Cambio del tipo MEP desde la compra (depreciacion/apreciacion del peso)',
      'th.usd_ret': 'Ret USD %',
      'th.usd_ret_tip': 'Retorno combinado de precio y moneda en USD',
      'th.value_usd': 'Valor USD',
      'th.value_usd_tip': 'Valor total de la posicion en USD',
      'th.pnl_usd': 'P&L USD',
      'th.pnl_usd_tip': 'Ganancia o perdida en dolares',
      'th.weight': 'Peso %',
      'th.weight_tip': 'Peso de la posicion como % del valor total del portafolio',

      // Technicals headers
      'th.tech_price_tip': 'Precio actual en USD',
      'th.ath': '% Bajo ATH',
      'th.ath_tip': 'Que tan lejos esta del maximo historico',
      'th.rsi': 'RSI(14)',
      'th.rsi_tip': 'Indice de Fuerza Relativa, 14 periodos',
      'th.stoch': 'Estoc K/D',
      'th.stoch_tip': 'Oscilador estocastico',
      'th.supertrend': 'Supertrend',
      'th.supertrend_tip': 'Indicador de seguimiento de tendencia',
      'th.sma20': 'vs SMA20',
      'th.sma20_tip': '% por encima o debajo de la media movil de 20 dias',
      'th.sma50': 'vs SMA50',
      'th.sma50_tip': '% por encima o debajo de la media movil de 50 dias',
      'th.health': 'Salud',
      'th.health_tip': 'Puntaje de salud combinado de todos los indicadores',

      // Fundamentals headers
      'th.pe_tip': 'Precio sobre ganancias ultimos 12 meses',
      ...
      'th.eps_gr_tip': 'Crecimiento de ganancias por accion interanual',
      'th.div_yld_tip': 'Rendimiento de dividendo anual',
      'th.de_tip': 'Ratio deuda sobre patrimonio',
      'th.margin_tip': 'Margen de ganancia neta',
      'th.sector_tip': 'Clasificacion sectorial GICS',
      'th.sector': 'Sector',

      // Table dynamic tooltips
      'tip.shares_held': 'Acciones en cartera',
      'tip.avg_ars_price': 'Precio promedio de compra en ARS por accion',
      'tip.free_shares': 'Acciones gratuitas por accion corporativa',
      'tip.us_no_ars': 'Activo US \u2014 sin precio en ARS',
      'tip.avg_usd_price': 'Precio promedio de compra en USD por accion',
      ...
      'tip.no_fx': 'Sin conversion FX \u2014 ya esta en USD',
      'tip.total_return_usd': 'Retorno total en USD desde la compra',
      'tip.position_value': 'Valor total de la posicion en USD',
      'tip.pnl_usd': 'Ganancia o perdida en USD',
      'tip.weight': '% del valor total del portafolio en USD',
      'tip.ratio': 'Ratio: ${ratio} (CEDEARs por accion)',

      // Technicals tooltips
      'tip.at_ath': 'En o cerca del maximo historico',
      'tip.far_ath': 'Mas de 50% debajo del ATH',
      'tip.below_ath': '% debajo del maximo historico',
      'tip.no_rsi': 'Sin datos de RSI',
      'tip.oversold': 'Sobrevendido \u2014 accion bajo presion',
      'tip.strong_momentum': 'Impulso fuerte',
      'tip.neutral_momentum': 'Impulso neutral',
      'tip.no_stoch': 'Sin datos de estocastico',
      'tip.oversold_zone': 'Zona de sobreventa',
      'tip.overbought_zone': 'Zona de sobrecompra',
      'tip.neutral_zone': 'Zona neutral',
      'tip.k_above_d': 'K sobre D \u2014 senal alcista',
      'tip.k_below_d': 'K debajo de D \u2014 senal bajista',
      'tip.from_oversold': ' (desde sobreventa)',
      'tip.from_overbought': ' (desde sobrecompra)',
      'tip.supertrend_up': 'Tendencia alcista \u2014 precio sobre linea Supertrend',
      'tip.supertrend_down': 'Tendencia bajista \u2014 precio debajo de linea Supertrend',
      'tip.supertrend_up_short': '\u25B2 Alza',
      'tip.supertrend_down_short': '\u25BC Baja',
      'tip.price_vs_sma': 'Precio vs SMA${period} (${value})',
      'tip.sma_label': 'Media de ${period} dias',
      ...
      'tip.benchmark_group': 'Grupo de comparacion',

      // Type labels & tips
      'type.cedear': 'CED',
      'type.arg_stock': 'ARG',
      'type.us_stock': 'US',
      'type.cedear_tip': 'CEDEAR \u2014 Certificado de deposito argentino (cotizado en ARS, convertido via MEP)',
      'type.arg_stock_tip': 'Accion argentina listada en BYMA (cotizada en ARS, convertida via MEP)',
      'type.us_stock_tip': 'Accion US (cotizada en USD)',
      ...
      'option.arg_stock': 'Accion Arg',
      'option.us_stock': 'Accion US',

      // Glossary
      'glossary.asset_types_title': 'Tipos de Activos y Conversion de Moneda',
      'glossary.cedear_def': '<strong class="text-white">CEDEAR</strong> \u2014 Certificado de Deposito Argentino. Wrapper local de acciones americanas, cotizado en ARS en BYMA. Valor en USD derivado via tipo MEP. El ratio (ej: 1:20) muestra cuantos CEDEARs equivalen a una accion US.',
      'glossary.arg_stock_def': '<strong class="text-white">Accion Argentina</strong> \u2014 Accion listada en BYMA, cotizada en ARS. Valor en USD derivado via tipo MEP.',
      'glossary.us_stock_def': '<strong class="text-white">Accion US</strong> \u2014 Accion listada en NYSE/NASDAQ, cotizada en USD. No necesita conversion de moneda.',
      'glossary.mep_def': '<strong class="text-white">MEP (Dolar MEP)</strong> \u2014 Tipo de cambio implicito obtenido via operaciones de bonos locales (AL30/AL30D). Usado para convertir activos en ARS a USD. Fuente: Data912.',
      'glossary.ccl_def': '<strong class="text-white">CCL (Dolar CCL)</strong> \u2014 Tipo de cambio implicito via arbitraje ADR (liquida en el exterior). Usado para mostrar acciones US en ARS.',

      'glossary.portfolio_title': 'Portafolio',
      'glossary.avg_ars_def': '<strong class="text-white">Prom ARS</strong> \u2014 Precio promedio de compra en ARS por accion. Solo se muestra para activos argentinos (CEDEARs, acciones arg).',
      'glossary.avg_usd_def': '<strong class="text-white">Prom USD</strong> \u2014 Precio promedio de compra en USD por accion.<br>Activos argentinos: <code class="text-accent">precio_ars \u00F7 tipo_mep_entrada</code><br>Acciones US: el precio de compra (ya en USD).',
      ...
      'glossary.currency_pct_def': '<strong class="text-white">Moneda %</strong> \u2014 Cambio en el tipo MEP desde la compra, reflejando depreciacion o apreciacion del peso. Solo aplica a activos argentinos.<br><code class="text-accent">(mep_entrada \u00F7 mep_actual \u2212 1) \u00D7 100</code>',
      'glossary.usd_ret_def': '<strong class="text-white">Ret USD %</strong> \u2014 Retorno total en USD, combinando efectos de precio y moneda. La composicion evita sobreestimar o subestimar el resultado real en USD.<br><code class="text-accent">(1 + precio%) \u00D7 (1 + moneda%) \u2212 1</code>',
      'glossary.value_usd_def': '<strong class="text-white">Valor USD</strong> \u2014 Valor total de la posicion en USD.<br><code class="text-accent">cantidad \u00D7 precio_usd</code>',
      'glossary.pnl_usd_def': '<strong class="text-white">P&L USD</strong> \u2014 Ganancia o perdida en dolares.<br><code class="text-accent">(precio_usd \u2212 prom_usd) \u00D7 cantidad</code>',
      'glossary.weight_def': '<strong class="text-white">Peso %</strong> \u2014 Tamano de la posicion como porcentaje del valor total del portafolio.<br><code class="text-accent">valor_usd \u00F7 total_portafolio_usd \u00D7 100</code>',

      'glossary.technicals_title': 'Tecnicos',
      'glossary.technicals_intro': 'Los colores muestran <strong class="text-white">salud del portafolio</strong>: <span class="text-gain">verde</span> = tenencia fuerte, <span class="text-loss">rojo</span> = tenencia debil. Los colores se desvanecen a blanco \u2014 solo los extremos tienen color pleno.',
      'glossary.ath_def': '<strong class="text-white">% Bajo ATH</strong> \u2014 Que tan lejos esta el precio actual de su maximo historico.<br><span class="text-gain">Verde pleno</span> en 0% (en ATH), se desvanece a blanco en 15%, <span class="text-loss">rojo pleno</span> en 30%+.<br><code class="text-accent">(precio \u00F7 maximo_historico \u2212 1) \u00D7 100</code>',
      'glossary.rsi_def': '<strong class="text-white">RSI(14)</strong> \u2014 Indice de Fuerza Relativa en 14 periodos. Mide el impulso comparando ganancias promedio vs perdidas promedio.<br><span class="text-loss">Rojo pleno</span> \u2264 20 (sobreventa profunda), se desvanece a blanco en 30, blanco 30\u201370 (neutral), se desvanece a verde en 80, <span class="text-gain">verde pleno</span> \u226580 (impulso fuerte).<br><code class="text-accent">100 \u2212 100 \u00F7 (1 + gan_prom \u00F7 perd_prom)</code>',
      'glossary.stoch_def': '<strong class="text-white">Estoc K/D</strong> \u2014 Oscilador estocastico. %K = donde cerro el precio vs el rango alto-bajo (14 periodos). %D = SMA de 3 periodos de %K. Cuando K cruza por encima de D, el impulso esta girando al alza (y viceversa).<br><span class="text-loss">Rojo pleno</span> en 0 (sobreventa profunda), se desvanece a blanco en 20, blanco 20\u201380 (neutral), se desvanece a verde en 80, <span class="text-gain">verde pleno</span> en 100.<br><code class="text-accent">%K = (cierre \u2212 min\u2081\u2084) \u00F7 (max\u2081\u2084 \u2212 min\u2081\u2084) \u00D7 100</code>',
      ...
      'glossary.sma_def': '<strong class="text-white">vs SMA20 / vs SMA50</strong> \u2014 Que tan lejos esta el precio por encima o debajo de la media movil simple de 20/50 dias, mostrado como %.<br>Blanco dentro de \u00B11%, se desvanece a <span class="text-gain">verde pleno</span> en +10% (sobre SMA) o <span class="text-loss">rojo pleno</span> en \u221210% (debajo de SMA). El tooltip muestra el valor real de la SMA. Para CEDEARs, usa el precio de la accion US subyacente.<br><code class="text-accent">(precio \u2212 SMA) \u00F7 SMA \u00D7 100</code>',
      ...
      'glossary.fundamentals_intro': 'Las metricas con color se comparan con <strong class="text-white">medianas sectoriales</strong>: <span class="text-gain">verde</span> = mejor que el sector, <span style="color: #d29922">amarillo</span> = cerca del promedio sectorial, <span class="text-loss">rojo</span> = peor que el sector. Cuando no hay datos sectoriales, se usan umbrales absolutos.',
      'glossary.pe_def': '<strong class="text-white">P/E</strong> \u2014 Precio sobre ganancias de los ultimos 12 meses. Menor es mejor (valuacion mas barata). <span class="text-gain">Verde</span> debajo de la mediana del sector, <span class="text-loss">rojo</span> por encima de 1.5\u00D7.<br><code class="text-accent">precio_accion \u00F7 ganancia_por_accion</code>',
      'glossary.fwd_pe_def': '<strong class="text-white">Fwd P/E</strong> \u2014 Precio sobre ganancias futuras estimadas. Misma interpretacion que P/E pero basado en estimaciones de analistas.<br><code class="text-accent">precio_accion \u00F7 gpa_futuro_estimado</code>',
      'glossary.pb_def': '<strong class="text-white">P/B</strong> \u2014 Precio sobre valor libro por accion. Compara precio de mercado con valor contable.<br><code class="text-accent">precio_accion \u00F7 valor_libro_por_accion</code>',
      ...
      'glossary.eps_gr_def': '<strong class="text-white">Crec GPA %</strong> \u2014 Crecimiento interanual de ganancia por accion.<br><code class="text-accent">(gpa_actual \u2212 gpa_anterior) \u00F7 |gpa_anterior| \u00D7 100</code>',
      'glossary.div_yld_def': '<strong class="text-white">Rend Div %</strong> \u2014 Rendimiento de dividendo anual como porcentaje del precio de la accion.<br><code class="text-accent">dividendos_anuales \u00F7 precio_accion \u00D7 100</code>',
